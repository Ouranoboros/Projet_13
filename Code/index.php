...
<html lang="fr">
	<head>
		...
		<link
			rel="stylesheet"
			href="assets/fonts/font-awesome.min.css?h=e7cfb9ec830984d637c4aed91cd725c5"
		/>
		<link
			rel="stylesheet"
	...
	<body>
		...
		<div id="Accueil" style="background-color: #ebf5ee">
			<!-- Start: 1 Row 2 Columns -->
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<img
							src="assets/img/MOUTIERS_-Pierre-_2_.webp?h=7a7191e38e965f06815fbd4d42c9d9cb"
							width="100%"
							height="100%"
							style="padding: 10px"
							alt="Portrait professionel"
						/>
					</div>
					<div
						class="col-md-6 d-xxl-flex justify-content-xxl-center align-items-xxl-center"
						style="padding: 10px"
					>
						<p
							class="text-center"
							style="font-family: Roboto, sans-serif; font-size: 25px"
						>
							<strong
								><span style="color: rgb(0, 0, 0); background-color: transparent"
									>Bonjour et bienvenue sur mon site !</span
								></strong
							><br /><br /><span
								style="color: rgb(0, 0, 0); background-color: transparent"
								>Vous pourrez y retrouver mon profil, mes projets réalisés durant ma
								première année à Guardia Cybersecurity School, 2 jeux intégrés et,
								si vous cherchez bien, quelques Easter Eggs.&nbsp;</span
							><br /><br /><span
								style="color: rgb(0, 0, 0); background-color: transparent"
								>N’hésitez pas à me contacter via le formulaire de contact ou
								directement par LinkedIn.&nbsp;</span
							><br /><br /><span
								style="color: rgb(0, 0, 0); background-color: transparent"
								>Ce site web a été réalisé dans le cadre d’un de mes projets
								d’études avec comme formateur référent Ludovic Fournier.</span
							>
						</p>
					</div>
				</div>
		...
		<div id="Profil" style="background-color: #bfa89e">
			<!-- Start: Banner Heading Image -->
			<section class="py-4 py-xl-5">
				<!-- Start: 1 Row 2 Columns -->
				<div class="container">
					<div
						class="bg-dark border rounded border-0 border-dark d-xxl-flex justify-content-xxl-center overflow-hidden"
					>
						<div class="row g-0">
							<div class="col-md-6" style="background-color: #78a1bb">
								<div class="text-white p-4 p-md-5">
									...
									<p
										...
										"
									>
										Je m’appelle Pierre Moutiers, j’ai 18 ans et je suis
										actuellement étudiant en Première année à Guardia
										Cybersecurity School. Passionné par l'informatique depuis
										tout petit, j'ai très vite souhaité m'orienter en
										cybersécurité, ce que j’ai l’occasion de faire grâce à ma
										formation.<br /><br />Animé par le travail en équipe et la
										conduite de projet, je m’implique et gère différentes
										organisations qui me permettent de me développer.&nbsp;<br /><br />Je
										suis également membre d’une association (les Jeunes IHEDN)
										et ancien joueur de rugby.
									</p>
									<div class="my-3">
										<a
											class="btn btn-primary btn-lg text-center d-lg-flex justify-content-lg-center me-2"
											role="button"
											href="https://www.linkedin.com/in/pierremoutiers/"
											target="_blank"
											>LinkedIn</a
										>
									</div>
							...
							>
								<img
									src="assets/img/cv%20projet.jpg?h=9d93e8e92d0e8e47424a47f3406b05e1"
									alt="Extrait de CV"
		...
		<section id="Projets" class="card-section-imagia" style="background-color: #ebf5ee">
			<!-- Start: H1 -->
			<h1>Mes Projets</h1>
			<!-- End: H1 -->
			<!-- Start: H2 -->
			<h2>réalisés durant ma première année</h2>
			<!-- End: H2 -->
			<div class="container">
				<div class="row">
				<?php
		...
		<div id="Engagements" style="background-color: #bfa89e">
			<!-- Start: Articles Cards -->
			<div class="container py-4 py-xl-5">
				<div class="row mb-5">
					<div class="col-md-8 col-xl-6 text-center mx-auto">
						<h2>Engagements</h2>
						<p>Les différents rôles que j'assume au sein de mon école.</p>
					</div>
				</div>
					...
					<div class="col">
						<div class="card">
							<img
								...
								style="height: 400px"
								src="assets/img/Quest%20Education%20Group.webp?h=50a9664043f7170ae0b0d89be28d0e5e"
								alt="Logo Quest Education Group"
							/>
							<div class="card-body p-4">
								<h4 class="card-title">Ambassadeur Quest Education Group</h4>
								<p class="card-text">
									Rôle de représentation des 4 écoles du groupe, lors des salons
									et journées portes ouvertes. J'ai pu participer cette année à
									plus d'une quinzaine d'événements et être au contact des futurs
									étudiants ou de professionnel du secteur.&nbsp;
								</p>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card">
							<img
								...
								data-bss-hover-animate="bounce"
								style="height: 400px"
								src="assets/img/Logo%20Task%20Force.webp?h=031a9053a6c6adecd00bd3d6365823b2"
								alt="Logo GTF"
							/>
							<div class="card-body p-4" style="background-color: EBF5EE">
								<h4 class="card-title">Fondateur de la Guardia Task Force</h4>
								<p class="card-text">
									Avec ma collègue déléguée Leelou Lerouge, nous avons fondé la
									GTF. Celle-ci a pour but de dynamiser et d'organiser des
									événements à destination des Guardians. Nous sommes notamment
									rentrés en contact avec de nombreux professionnels, afin de les
									faire intervenir.&nbsp;
								</p>
							</div>
						</div>
					...
					<div class="col">
						<div class="card">
							<img
								class="card-img-top w-100 d-block fit-cover"
								data-bss-hover-animate="bounce"
								src="assets/img/BDE.webp?h=17f8c92aab60a89ec1c1dbb515ee4daf"
								style="height: 400px"
								alt="Logo BDE"
							/>
							<div class="card-body p-4">
								<h4 class="card-title">Président du BDE - Le QG</h4>
								<p class="card-text">
									Actuellement en campagne, je suis le président de la liste que
									nous proposons afin d'assumer la charge de BDE Quest. Avec mes
									collègues du groupe, nous souhaitons dynamiser la vie de campus
									et établir une véritable ambiance de campus.
								</p>
							</div>
						</div>
					</div>
			...
			<section class="getintouch">
				<div class="container modern-form">
					<div class="text-center">
						<h4 style="color: #212529; font-size: 45px">Me Contacter</h4>
					</div>
				...
				<div class="row row-cols-1 row-cols-lg-3">
					...
					<div class="col">
						<ul class="list-inline my-2">
							...
							<li class="list-inline-item me-4" style="width: 35px; height: 35px">
								<span
									class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"
									data-bss-hover-animate="rubberBand"
									style="
		...
		<div class="modal fade" role="dialog" tabindex="-1" id="modal-1">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div
						class="modal-header d-inline-flex flex-grow-0 justify-content-between align-items-center align-content-center"
					>
						<h4 class="modal-title text-secondary">Connexion</h4>
						<button
							class="btn-close"
							type="button"
							aria-label="Close"
					...
					<div class="modal-body">
						<form class="login-form" method="POST" action="index.php" id="form_login">
							...
							<div class="form-group mb-3">
								<button class="btn btn-light btn-lg login-btn" type="submit" name="submit">
